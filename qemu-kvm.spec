...
Patch615: kvm-memory-emulate-ioeventfd.patch
# For bz#1374623 - RHSA-2016-1756 breaks migration of instances
Patch616: kvm-virtio-recalculate-vq-inuse-after-migration.patch
# For bz#1375642 - Increase the queue size to the max allowed, 1024.
Patch617: kvm-virtio-net-allow-increasing-rx-queue-size.patch
# For bz#1380310 - match the OEM ID and OEM Table ID fields of the FADT and the RSDT to those of the SLIC [7.2.z]
Patch618: kvm-acpi-support-specified-oem-table-id-for-build_header.patch
# For bz#1380310 - match the OEM ID and OEM Table ID fields of the FADT and the RSDT to those of the SLIC [7.2.z]
Patch619: kvm-acpi-take-oem_id-in-build_header-optionally.patch
# For bz#1380310 - match the OEM ID and OEM Table ID fields of the FADT and the RSDT to those of the SLIC [7.2.z]
Patch620: kvm-acpi-expose-oem_id-and-oem_table_id-in-build_rsdt.patch
# For bz#1380310 - match the OEM ID and OEM Table ID fields of the FADT and the RSDT to those of the SLIC [7.2.z]
Patch621: kvm-acpi-add-function-to-extract-oem_id-and-oem_table_id.patch
# For bz#1380310 - match the OEM ID and OEM Table ID fields of the FADT and the RSDT to those of the SLIC [7.2.z]
Patch622: kvm-pc-set-the-OEM-fields-in-the-RSDT-and-the-FADT-from-.patch
# For bz#1380320 - Race condition during virtio-blk dataplane stop triggers "Virtqueue size exceeded"
...
ApplyPatch libiscsi-Batch-pdu-read-in-function-iscsi_tcp_service.patch
ApplyPatch libiscsi-add-default-scsi-timeout-45s.patch
ApplyPatch libiscsi-scan-timed-out-cmd-in-nop-out.patch
...
%changelog
* Thu Jan 19 2017 Keyue Hu <keyue@smartx.com> - zbs-2.6.0-35.el7
- translate scsi sense code into error code

* Thu Jan 19 2017 Keyue Hu <keyue@smartx.com> - zbs-2.6.0-34.el7
- set default iscsi timeout to 45s with 5 times
- remove iscsi-co-flush
- increate iscsi retry times
- retry on libiscsi timeout

* Tue Jan 17 2017 Keyue Hu <keyue@smartx.com> - zbs-2.6.0-30.el7
- apply libiscsi batch pdu patch
- integrate with libiscsi 1.18.0

* Fri Oct 14 2016 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.3.0-31.el7_2.23
- kvm-acpi-support-specified-oem-table-id-for-build_header.patch [bz#1380310]
- kvm-acpi-take-oem_id-in-build_header-optionally.patch [bz#1380310]
- kvm-acpi-expose-oem_id-and-oem_table_id-in-build_rsdt.patch [bz#1380310]
- kvm-acpi-add-function-to-extract-oem_id-and-oem_table_id.patch [bz#1380310]
- kvm-pc-set-the-OEM-fields-in-the-RSDT-and-the-FADT-from-.patch [bz#1380310]
- kvm-dataplane-fix-virtio-blk-complete_request-race-condi.patch [bz#1380320]
- Resolves: bz#1380310
  (match the OEM ID and OEM Table ID fields of the FADT and the RSDT to those of the SLIC [7.2.z])
- Resolves: bz#1380320
  (Race condition during virtio-blk dataplane stop triggers "Virtqueue size exceeded")

* Wed Sep 14 2016 Miroslav Rezanina <mrezanin@redhat.com> - rhev-2.3.0-31.el7_2.22
- kvm-memory-emulate-ioeventfd.patch [bz#1374623]
- kvm-virtio-recalculate-vq-inuse-after-migration.patch [bz#1374623]
- kvm-virtio-net-allow-increasing-rx-queue-size.patch [bz#1375642]
- Resolves: bz#1374623
